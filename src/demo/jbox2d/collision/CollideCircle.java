...
public class CollideCircle {
    ...
    public static void collideCircles(Manifold manifold,
        ...
        demo.jbox2d.common.Vec2 d = p2.sub(p1);

        float distSqr = demo.jbox2d.common.Vec2.dot(d, d);
        ...
        float separation;
        if (distSqr < demo.jbox2d.common.Settings.EPSILON) {
        ...
        demo.jbox2d.common.Vec2 p = new demo.jbox2d.common.Vec2(0.5f * (p1.x + p2.x), 0.5f * (p1.y + p2.y));
    ...
    public static void collidePolygonAndCircle(Manifold manifold,
        ...
        demo.jbox2d.common.Vec2 c = XForm.mul(xf2, circle.getLocalPosition());
        demo.jbox2d.common.Vec2 cLocal = XForm.mulT(xf1, c);
        ...
        demo.jbox2d.common.Vec2[] vertices = polygon.getVertices();
        demo.jbox2d.common.Vec2[] normals = polygon.getNormals();
        for (int i = 0; i < vertexCount; ++i) {

            float s = demo.jbox2d.common.Vec2.dot(normals[i], cLocal.sub(vertices[i]));
        ...
        if (separation < demo.jbox2d.common.Settings.EPSILON) {
            manifold.pointCount = 1;
            manifold.normal = demo.jbox2d.common.Mat22.mul(xf1.R, normals[normalIndex]);
            ...
            demo.jbox2d.common.Vec2 position = c.sub(manifold.normal.mul(radius));
        ...
        demo.jbox2d.common.Vec2 e = vertices[vertIndex2].sub(vertices[vertIndex1]);
        float length = e.normalize();
        assert (length > demo.jbox2d.common.Settings.EPSILON);

        // Project the center onto the edge.
        float u = demo.jbox2d.common.Vec2.dot(cLocal.sub(vertices[vertIndex1]), e);

        demo.jbox2d.common.Vec2 p = new demo.jbox2d.common.Vec2();
        if (u <= 0.0f) {
        ...
        demo.jbox2d.common.Vec2 d = cLocal.sub(p);
        ...
        manifold.normal = demo.jbox2d.common.Mat22.mul(xf1.R, d);
        demo.jbox2d.common.Vec2 position = c.sub(manifold.normal.mul(radius));
        manifold.points[0].localPoint1 = XForm.mulT(xf1, position);
        manifold.points[0].localPoint2 = XForm.mulT(xf2, position);
