...
package demo.jbox2d.dynamics.contacts;

import demo.jbox2d.collision.Manifold;
import demo.jbox2d.collision.Shape;
import demo.jbox2d.collision.ShapeType;
import demo.jbox2d.common.MathUtils;
import demo.jbox2d.dynamics.Body;
import demo.jbox2d.dynamics.ContactListener;
import demo.jbox2d.dynamics.World;
...
public abstract class Contact {
    ...
    public demo.jbox2d.collision.Shape m_shape1;
    public demo.jbox2d.collision.Shape m_shape2;
    ...
    public Contact(demo.jbox2d.collision.Shape s1, demo.jbox2d.collision.Shape s2) {
        this();
    ...
    static void initializeRegisters() {
        ...
        addType(new CircleContact(), demo.jbox2d.collision.ShapeType.CIRCLE_SHAPE,
                demo.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyAndCircleContact(), demo.jbox2d.collision.ShapeType.POLYGON_SHAPE,
                demo.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyContact(), demo.jbox2d.collision.ShapeType.POLYGON_SHAPE, demo.jbox2d.collision.ShapeType.POLYGON_SHAPE);
        // AddType(new PolyContact(), ShapeType.BOX_SHAPE, ShapeType.BOX_SHAPE);
    }

    static void addType(ContactCreateFcn createFcn, demo.jbox2d.collision.ShapeType type1,
                        demo.jbox2d.collision.ShapeType type2) {
     ...
     */
    public static Contact createContact(demo.jbox2d.collision.Shape shape1, Shape shape2) {
        if (s_initialized == false) {
            initializeRegisters();
            s_initialized = true;
        }

        demo.jbox2d.collision.ShapeType type1 = shape1.m_type;
        demo.jbox2d.collision.ShapeType type2 = shape2.m_type;
    ...
    private static ContactRegister getContactRegister(demo.jbox2d.collision.ShapeType type1,
                                                      ShapeType type2) {
     ...
     */
    public abstract List<demo.jbox2d.collision.Manifold> getManifolds();
    ...
    public demo.jbox2d.collision.Shape getShape1() {
        return m_shape1;
    }

    public demo.jbox2d.collision.Shape getShape2() {
        return m_shape2;
    }
    ...
    public void update(ContactListener listener) {
        ...
        demo.jbox2d.dynamics.Body body1 = m_shape1.getBody();
