...
import demo.jbox2d.collision.CircleDef;
import demo.jbox2d.common.Vec2;
import demo.jbox2d.dynamics.Body;
import demo.jbox2d.dynamics.BodyDef;
import demo.jbox2d.dynamics.World;
import demo.jbox2d.dynamics.joints.DistanceJointDef;
import demo.jbox2d.dynamics.joints.Joint;
import demo.jbox2d.util.blob.BlobStructure.IntIntFloatFloat;
...
public class BlobMaker {
     ...
     */
    static public void createBlob(demo.jbox2d.util.blob.BlobStructure s, BlobContainer c, World w) {
    ...
    static public void createBlob(BlobStructure s, BlobContainer c, World w,
        ...
        demo.jbox2d.dynamics.Body[] bodies = new demo.jbox2d.dynamics.Body[nPoints];
        ...
        for (int j = 0; j < nHeight; ++j) {
            ...
            for (int i = 0; i < nWidth; ++i) {
                ...
                for (int k = 0; k < nPerCell; ++k) {
                    demo.jbox2d.common.Vec2 position = new Vec2(s.points.get(k).position.x + xStart,
                    ...
                    demo.jbox2d.dynamics.BodyDef bd = new BodyDef();
