...
public class PolyContact extends Contact implements ContactCreateFcn {
    ...
    public PolyContact(com.mona.jbox2d.collision.Shape s1, com.mona.jbox2d.collision.Shape s2) {
        super(s1, s2);
        assert (m_shape1.getType() == com.mona.jbox2d.collision.ShapeType.POLYGON_SHAPE);
    ...
    public Contact clone() {
        ...
        if (this.m_manifold != null) newC.m_manifold = new com.mona.jbox2d.collision.Manifold(this.m_manifold);
    ...
    public List<com.mona.jbox2d.collision.Manifold> getManifolds() {
        ...
        List<com.mona.jbox2d.collision.Manifold> ret = new ArrayList<com.mona.jbox2d.collision.Manifold>();
        if (m_manifold != null) {
            ret.add(m_manifold);
        }
    ...
    public Contact create(com.mona.jbox2d.collision.Shape shape1, Shape shape2) {
        return new PolyContact(shape1, shape2);
    }

    public void dumpManifoldPoints() {
        for (int i = 0; i < m_manifold.pointCount; ++i) {
            com.mona.jbox2d.collision.ManifoldPoint mp = m_manifold.points[i];
    ...
    public void evaluate(ContactListener listener) {
        ...
        com.mona.jbox2d.collision.Manifold m0 = new Manifold(m_manifold);
        ...
        CollidePoly.collidePolygons(m_manifold, (com.mona.jbox2d.collision.PolygonShape) m_shape1, b1.getXForm(), (PolygonShape) m_shape2, b2.getXForm());

        boolean[] persisted = {false, false};

        com.mona.jbox2d.dynamics.contacts.ContactPoint cp = new ContactPoint();
        cp.shape1 = m_shape1;
        cp.shape2 = m_shape2;
        ...
        if (m_manifold.pointCount > 0) {
            ...
            for (int i = 0; i < m_manifold.pointCount; ++i) {
                ...
                boolean found = false;
                com.mona.jbox2d.collision.ContactID id = new com.mona.jbox2d.collision.ContactID(mp.id);
                ...
                for (int j = 0; j < m0.pointCount; ++j) {
                    ...
                    com.mona.jbox2d.collision.ManifoldPoint mp0 = m0.points[j];
                    ...
                    if (mp0.id.isEqual(id)) {
                        ...
                        if (listener != null) {
                            ...
                            cp.id = new com.mona.jbox2d.collision.ContactID(id);
                            listener.persist(cp);
                        }
                        break;
                    }
