...
public abstract class Joint {
    ...
    public com.jbox2d.dynamics.joints.JointType m_type;

    public Joint m_prev;

    public Joint m_next;

    public com.jbox2d.dynamics.joints.JointEdge m_node1;

    public com.jbox2d.dynamics.joints.JointEdge m_node2;

    public com.jbox2d.dynamics.Body m_body1;

    public com.jbox2d.dynamics.Body m_body2;
    ...
    public Joint(com.jbox2d.dynamics.joints.JointDef description) {
        m_type = description.type;
        m_prev = null;
        m_next = null;
        m_node1 = new com.jbox2d.dynamics.joints.JointEdge();
    ...
    public static Joint create(JointDef description) {
        ...
        if (description.type == com.jbox2d.dynamics.joints.JointType.DISTANCE_JOINT) {
            joint = new DistanceJoint((DistanceJointDef) description);
        } else if (description.type == com.jbox2d.dynamics.joints.JointType.MOUSE_JOINT) {
            joint = new MouseJoint((MouseJointDef) description);
        } else if (description.type == com.jbox2d.dynamics.joints.JointType.PRISMATIC_JOINT) {
            joint = new PrismaticJoint((PrismaticJointDef) description);
        } else if (description.type == com.jbox2d.dynamics.joints.JointType.REVOLUTE_JOINT) {
            joint = new RevoluteJoint((RevoluteJointDef) description);
        } else if (description.type == com.jbox2d.dynamics.joints.JointType.PULLEY_JOINT) {
            joint = new PulleyJoint((PulleyJointDef) description);
        } else if (description.type == com.jbox2d.dynamics.joints.JointType.GEAR_JOINT) {
     ...
     */
    public com.jbox2d.dynamics.Body getBody1() {
        return m_body1;
    }
    ...
    public abstract void initVelocityConstraints(com.jbox2d.dynamics.TimeStep step);
