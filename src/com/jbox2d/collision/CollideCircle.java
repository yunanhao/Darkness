...
public class CollideCircle {
    ...
    public static void collideCircles(Manifold manifold,
        ...
        com.jbox2d.common.Vec2 d = p2.sub(p1);

        float distSqr = com.jbox2d.common.Vec2.dot(d, d);
        ...
        float separation;
        if (distSqr < com.jbox2d.common.Settings.EPSILON) {
        ...
        com.jbox2d.common.Vec2 p = new com.jbox2d.common.Vec2(0.5f * (p1.x + p2.x), 0.5f * (p1.y + p2.y));
    ...
    public static void collidePolygonAndCircle(Manifold manifold,
        ...
        com.jbox2d.common.Vec2 c = XForm.mul(xf2, circle.getLocalPosition());
        com.jbox2d.common.Vec2 cLocal = XForm.mulT(xf1, c);
        ...
        com.jbox2d.common.Vec2[] vertices = polygon.getVertices();
        com.jbox2d.common.Vec2[] normals = polygon.getNormals();
        for (int i = 0; i < vertexCount; ++i) {

            float s = com.jbox2d.common.Vec2.dot(normals[i], cLocal.sub(vertices[i]));
        ...
        if (separation < com.jbox2d.common.Settings.EPSILON) {
            manifold.pointCount = 1;
            manifold.normal = com.jbox2d.common.Mat22.mul(xf1.R, normals[normalIndex]);
            ...
            com.jbox2d.common.Vec2 position = c.sub(manifold.normal.mul(radius));
        ...
        com.jbox2d.common.Vec2 e = vertices[vertIndex2].sub(vertices[vertIndex1]);
        float length = e.normalize();
        assert (length > com.jbox2d.common.Settings.EPSILON);

        // Project the center onto the edge.
        float u = com.jbox2d.common.Vec2.dot(cLocal.sub(vertices[vertIndex1]), e);

        com.jbox2d.common.Vec2 p = new com.jbox2d.common.Vec2();
        if (u <= 0.0f) {
        ...
        com.jbox2d.common.Vec2 d = cLocal.sub(p);
        ...
        manifold.normal = com.jbox2d.common.Mat22.mul(xf1.R, d);
        com.jbox2d.common.Vec2 position = c.sub(manifold.normal.mul(radius));
        manifold.points[0].localPoint1 = XForm.mulT(xf1, position);
        manifold.points[0].localPoint2 = XForm.mulT(xf2, position);
