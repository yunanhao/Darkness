...
import demo.jbox2d.collision.MassData;
import demo.jbox2d.collision.Shape;
import demo.jbox2d.collision.ShapeDef;
import demo.jbox2d.common.Mat22;
import demo.jbox2d.dynamics.contacts.ContactEdge;
import demo.jbox2d.dynamics.joints.JointEdge;
...
public class Body {
     ...
     */
    public demo.jbox2d.common.XForm m_xf;

    /**
     * The swept motion for CCD
     */
    public demo.jbox2d.common.Sweep m_sweep;

    public demo.jbox2d.common.Vec2 m_linearVelocity;
    public float m_angularVelocity;

    public demo.jbox2d.common.Vec2 m_force;
    public float m_torque;

    public demo.jbox2d.dynamics.World m_world;
    public Body m_prev;
    public Body m_next;
     ...
     */
    public Body(BodyDef bd, demo.jbox2d.dynamics.World world) {
        ...
        m_xf = new demo.jbox2d.common.XForm();

        m_xf.position.set(bd.position);
        m_xf.R.set(bd.angle);

        m_sweep = new demo.jbox2d.common.Sweep();
        m_sweep.localCenter.set(bd.massData.center);
        m_sweep.t0 = 1.0f;
        m_sweep.a0 = m_sweep.a = bd.angle;
        m_sweep.c.set(demo.jbox2d.common.XForm.mul(m_xf, m_sweep.localCenter));
        ...
        m_force = new demo.jbox2d.common.Vec2(0.0f, 0.0f);
        m_torque = 0.0f;

        m_linearVelocity = new demo.jbox2d.common.Vec2(0.0f, 0.0f);
    ...
    public void setMassFromShapes() {
        ...
        if (m_I > 0.0f && (m_flags & e_fixedRotationFlag) == 0) {
            ...
            m_I -= m_mass * demo.jbox2d.common.Vec2.dot(center, center);
            assert (m_I > 0.0f);
            m_invI = 1.0f / m_I;
        } else {
            m_I = 0.0f;
     ...
     */
    public boolean setXForm(demo.jbox2d.common.Vec2 position, float angle) {
        assert (m_world.m_lock == false);
     ...
     */
    public demo.jbox2d.common.XForm getXForm() {
        demo.jbox2d.common.XForm xf = new demo.jbox2d.common.XForm();
        xf.set(m_xf);
        return xf;
    }
     ...
     */
    public demo.jbox2d.common.Vec2 getPosition() {
     ...
     */
    public demo.jbox2d.common.Vec2 getWorldCenter() {
     ...
     */
    public demo.jbox2d.common.Vec2 getLocalCenter() {
     ...
     */
    public demo.jbox2d.common.Vec2 getLinearVelocity() {
     ...
     */
    public void setLinearVelocity(demo.jbox2d.common.Vec2 v) {
     ...
     */
    public void applyForce(demo.jbox2d.common.Vec2 force, demo.jbox2d.common.Vec2 point) {
        if (isSleeping()) wakeUp();
        m_force.addLocal(force);
        m_torque += demo.jbox2d.common.Vec2.cross(point.sub(m_sweep.c), force);
    }
     ...
     * @param point   the world position of the point of application.
     */
    public void applyImpulse(demo.jbox2d.common.Vec2 impulse, demo.jbox2d.common.Vec2 point) {
        if (isSleeping()) wakeUp();
        m_linearVelocity.x += m_invMass * impulse.x;
        m_linearVelocity.y += m_invMass * impulse.y;
        m_angularVelocity += m_invI * demo.jbox2d.common.Vec2.cross(point.sub(m_sweep.c), impulse);
    }
     ...
     */
    public demo.jbox2d.common.Vec2 getWorldPoint(demo.jbox2d.common.Vec2 localPoint) {
        return demo.jbox2d.common.XForm.mul(m_xf, localPoint);
    }
     ...
     */
    public demo.jbox2d.common.Vec2 getWorldVector(demo.jbox2d.common.Vec2 localVector) {
     ...
     */
    public demo.jbox2d.common.Vec2 getLocalPoint(demo.jbox2d.common.Vec2 worldPoint) {
        return demo.jbox2d.common.XForm.mulT(m_xf, worldPoint);
    }
     ...
     */
    public demo.jbox2d.common.Vec2 getLocalVector(demo.jbox2d.common.Vec2 worldVector) {
    ...
    public boolean synchronizeShapes() {
        demo.jbox2d.common.XForm xf1 = new demo.jbox2d.common.XForm();
    ...
    public void synchronizeTransform() {
        ...
        demo.jbox2d.common.Vec2 v1 = m_sweep.localCenter;
     ...
     */
    public demo.jbox2d.common.Vec2 getLinearVelocityFromWorldPoint(demo.jbox2d.common.Vec2 worldPoint) {
        return m_linearVelocity.add(demo.jbox2d.common.Vec2.cross(m_angularVelocity, worldPoint.sub(m_sweep.c)));
    }
     ...
     * @return the world velocity of a point.
     */
    public demo.jbox2d.common.Vec2 getLinearVelocityFromLocalPoint(demo.jbox2d.common.Vec2 localPoint) {
