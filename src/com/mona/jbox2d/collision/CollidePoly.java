...
public class CollidePoly {
    ...
    static float edgeSeparation(PolygonShape poly1, com.mona.jbox2d.common.XForm xf1,
                                int edge1,
        ...
        Vec2 normal1World = com.mona.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]);
    ...
    // from poly1.
    static MaxSeparation findMaxSeparation(PolygonShape poly1, com.mona.jbox2d.common.XForm xf1,
                                           PolygonShape poly2, com.mona.jbox2d.common.XForm xf2) {
    ...
    static void findIncidentEdge(ClipVertex c[],
        ...
        Vec2 normal1 = com.mona.jbox2d.common.Mat22.mulT(xf2.R, com.mona.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]));
        ...
        c[0].v = com.mona.jbox2d.common.XForm.mul(xf2, vertices2[i1]);
        c[0].id.features.referenceEdge = edge1;
        c[0].id.features.incidentEdge = i1;
        c[0].id.features.incidentVertex = 0;


        c[1].v = com.mona.jbox2d.common.XForm.mul(xf2, vertices2[i2]);
    ...
    public static void collidePolygons(Manifold manif,
                                       PolygonShape polyA, com.mona.jbox2d.common.XForm xfA,
                                       PolygonShape polyB, com.mona.jbox2d.common.XForm xfB) {
        ...
        com.mona.jbox2d.common.XForm xf2 = new com.mona.jbox2d.common.XForm();
        ...
        Vec2 sideNormal = com.mona.jbox2d.common.Mat22.mul(xf1.R, v12.sub(v11));
        ...
        int pointCount = 0;
        for (int i = 0; i < com.mona.jbox2d.common.Settings.maxManifoldPoints; ++i) {
