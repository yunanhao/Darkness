...
public class CollidePoly {
    ...
    static float edgeSeparation(PolygonShape poly1, demo.jbox2d.common.XForm xf1,
                                int edge1,
                                PolygonShape poly2, demo.jbox2d.common.XForm xf2) {
        ...
        Vec2 normal1World = demo.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]);
    ...
    // from poly1.
    static MaxSeparation findMaxSeparation(PolygonShape poly1, demo.jbox2d.common.XForm xf1,
                                           PolygonShape poly2, demo.jbox2d.common.XForm xf2) {
    ...
    static void findIncidentEdge(ClipVertex[] c,
                                 PolygonShape poly1, demo.jbox2d.common.XForm xf1, int edge1,
                                 PolygonShape poly2, demo.jbox2d.common.XForm xf2) {
        ...
        Vec2 normal1 = demo.jbox2d.common.Mat22.mulT(xf2.R, demo.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]));
        ...
        c[0].v = demo.jbox2d.common.XForm.mul(xf2, vertices2[i1]);
        c[0].id.features.referenceEdge = edge1;
        c[0].id.features.incidentEdge = i1;
        c[0].id.features.incidentVertex = 0;


        c[1].v = demo.jbox2d.common.XForm.mul(xf2, vertices2[i2]);
    ...
    public static void collidePolygons(Manifold manif,
                                       PolygonShape polyA, demo.jbox2d.common.XForm xfA,
                                       PolygonShape polyB, demo.jbox2d.common.XForm xfB) {
        ...
        demo.jbox2d.common.XForm xf2 = new demo.jbox2d.common.XForm();
        ...
        Vec2 sideNormal = demo.jbox2d.common.Mat22.mul(xf1.R, v12.sub(v11));
        ...
        int pointCount = 0;
        for (int i = 0; i < demo.jbox2d.common.Settings.maxManifoldPoints; ++i) {
