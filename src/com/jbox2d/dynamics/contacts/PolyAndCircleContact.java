...
class PolyAndCircleContact extends Contact implements ContactCreateFcn {
    ...
    public PolyAndCircleContact(com.jbox2d.collision.Shape s1, com.jbox2d.collision.Shape s2) {
        super(s1, s2);
    ...
    public Contact clone() {
        PolyAndCircleContact newC = new PolyAndCircleContact(this.m_shape1,
                this.m_shape2);
        newC.m_manifold = new com.jbox2d.collision.Manifold(this.m_manifold);
    ...
    public List<com.jbox2d.collision.Manifold> getManifolds() {
        List<com.jbox2d.collision.Manifold> ret = new ArrayList<com.jbox2d.collision.Manifold>(1);
        if (m_manifold != null) {
            ret.add(m_manifold);
        }
        return ret;
