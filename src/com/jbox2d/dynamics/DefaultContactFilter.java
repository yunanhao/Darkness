...
import com.jbox2d.collision.FilterData;
...
public class DefaultContactFilter implements ContactFilter {
     ...
     */
    public boolean shouldCollide(com.jbox2d.collision.Shape shape1, Shape shape2) {

        com.jbox2d.collision.FilterData filter1 = shape1.getFilterData();
