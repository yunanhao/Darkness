...
public class CollidePoly {
    ...
    static float edgeSeparation(PolygonShape poly1, com.jbox2d.common.XForm xf1,
                                int edge1,
                                PolygonShape poly2, com.jbox2d.common.XForm xf2) {
        ...
        Vec2 normal1World = com.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]);
    ...
    // from poly1.
    static MaxSeparation findMaxSeparation(PolygonShape poly1, com.jbox2d.common.XForm xf1,
                                           PolygonShape poly2, com.jbox2d.common.XForm xf2) {
    ...
    static void findIncidentEdge(ClipVertex[] c,
                                 PolygonShape poly1, com.jbox2d.common.XForm xf1, int edge1,
                                 PolygonShape poly2, com.jbox2d.common.XForm xf2) {
        ...
        Vec2 normal1 = com.jbox2d.common.Mat22.mulT(xf2.R, com.jbox2d.common.Mat22.mul(xf1.R, normals1[edge1]));
        ...
        c[0].v = com.jbox2d.common.XForm.mul(xf2, vertices2[i1]);
        c[0].id.features.referenceEdge = edge1;
        c[0].id.features.incidentEdge = i1;
        c[0].id.features.incidentVertex = 0;


        c[1].v = com.jbox2d.common.XForm.mul(xf2, vertices2[i2]);
    ...
    public static void collidePolygons(Manifold manif,
                                       PolygonShape polyA, com.jbox2d.common.XForm xfA,
                                       PolygonShape polyB, com.jbox2d.common.XForm xfB) {
        ...
        com.jbox2d.common.XForm xf2 = new com.jbox2d.common.XForm();
        ...
        Vec2 sideNormal = com.jbox2d.common.Mat22.mul(xf1.R, v12.sub(v11));
        ...
        int pointCount = 0;
        for (int i = 0; i < com.jbox2d.common.Settings.maxManifoldPoints; ++i) {
