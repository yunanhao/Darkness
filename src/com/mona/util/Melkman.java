...
public class Melkman {
    ...
    public Point[] getTubaoPoint() {
        ...
        for (i++; i < N; i++) {
            ...
            if (isLeft(pointArray[D[top - 2]], pointArray[D[top - 1]], pointArray[i]) > 0 && isLeft(pointArray[D[bot + 1]],
                    pointArray[D[bot + 2]], pointArray[i]) > 0) {
                continue;
            }
