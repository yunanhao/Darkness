...
public class DistanceJoint extends Joint {
    ...
    @Override
    public void initVelocityConstraints(com.jbox2d.dynamics.TimeStep step) {
        m_inv_dt = step.inv_dt;

        //TODO: fully inline temp Vec2 ops
        com.jbox2d.dynamics.Body b1 = m_body1;
        com.jbox2d.dynamics.Body b2 = m_body2;

        // Compute the effective mass matrix.
        Vec2 r1 = com.jbox2d.common.Mat22.mul(b1.getXForm().R, m_localAnchor1.sub(b1.getLocalCenter()));
        Vec2 r2 = com.jbox2d.common.Mat22.mul(b2.getXForm().R, m_localAnchor2.sub(b2.getLocalCenter()));
        m_u.x = b2.m_sweep.c.x + r2.x - b1.m_sweep.c.x - r1.x;
        m_u.y = b2.m_sweep.c.y + r2.y - b1.m_sweep.c.y - r1.y;

        // Handle singularity.
        float length = m_u.length();
        if (length > com.jbox2d.common.Settings.linearSlop) {
            m_u.x *= 1.0f / length;
            m_u.y *= 1.0f / length;
        } else {
            m_u.set(0.0f, 0.0f);
        ...
        assert (invMass > com.jbox2d.common.Settings.EPSILON);
        m_mass = 1.0f / invMass;
    ...
    public boolean solvePositionConstraints() {
        ...
        float C = length - m_length;
        C = com.jbox2d.common.MathUtils.clamp(C, -com.jbox2d.common.Settings.maxLinearCorrection, com.jbox2d.common.Settings.maxLinearCorrection);
        ...
        return Math.abs(C) < com.jbox2d.common.Settings.linearSlop;
    }
    ...
    public void solveVelocityConstraints(TimeStep step) {
        ...
        Vec2 r1 = com.jbox2d.common.Mat22.mul(b1.m_xf.R, m_localAnchor1.sub(b1.getLocalCenter()));
        Vec2 r2 = com.jbox2d.common.Mat22.mul(b2.m_xf.R, m_localAnchor2.sub(b2.getLocalCenter()));
