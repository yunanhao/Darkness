...
import com.mona.jbox2d.dynamics.contacts.ContactPoint;
import com.mona.jbox2d.dynamics.contacts.NullContact;
...
public class ContactManager extends PairCallback {
    ...
    public Object pairAdded(Object proxyUserData1, Object proxyUserData2) {
        com.mona.jbox2d.collision.Shape shape1 = (com.mona.jbox2d.collision.Shape) proxyUserData1;
        com.mona.jbox2d.collision.Shape shape2 = (com.mona.jbox2d.collision.Shape) proxyUserData2;
    ...
    public void destroy(Contact c) {
        com.mona.jbox2d.collision.Shape shape1 = c.getShape1();
        ...
        if (manifoldCount > 0 && (m_world.m_contactListener != null)) {
            ...
            List<com.mona.jbox2d.collision.Manifold> manifolds = c.getManifolds();
