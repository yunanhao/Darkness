...
import com.jbox2d.collision.ShapeType;
...
public abstract class Contact {
    ...
    public com.jbox2d.collision.Shape m_shape1;
    public com.jbox2d.collision.Shape m_shape2;
    ...
    public Contact(com.jbox2d.collision.Shape s1, com.jbox2d.collision.Shape s2) {
        this();
    ...
    static void initializeRegisters() {
        ...
        addType(new CircleContact(), com.jbox2d.collision.ShapeType.CIRCLE_SHAPE,
                com.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyAndCircleContact(), com.jbox2d.collision.ShapeType.POLYGON_SHAPE,
                com.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyContact(), com.jbox2d.collision.ShapeType.POLYGON_SHAPE, com.jbox2d.collision.ShapeType.POLYGON_SHAPE);
        // AddType(new PolyContact(), ShapeType.BOX_SHAPE, ShapeType.BOX_SHAPE);
    }

    static void addType(ContactCreateFcn createFcn, com.jbox2d.collision.ShapeType type1,
                        com.jbox2d.collision.ShapeType type2) {
     ...
     */
    public static Contact createContact(com.jbox2d.collision.Shape shape1, Shape shape2) {
        if (s_initialized == false) {
            initializeRegisters();
            s_initialized = true;
        }

        com.jbox2d.collision.ShapeType type1 = shape1.m_type;
        com.jbox2d.collision.ShapeType type2 = shape2.m_type;
    ...
    private static ContactRegister getContactRegister(com.jbox2d.collision.ShapeType type1,
                                                      ShapeType type2) {
     ...
     */
    public abstract List<com.jbox2d.collision.Manifold> getManifolds();
    ...
    public com.jbox2d.collision.Shape getShape1() {
        return m_shape1;
    }

    public com.jbox2d.collision.Shape getShape2() {
        return m_shape2;
    }
    ...
    public void update(ContactListener listener) {
        ...
        com.jbox2d.dynamics.Body body1 = m_shape1.getBody();
