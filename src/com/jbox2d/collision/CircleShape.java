...
public class CircleShape extends Shape {
    ...
    public void updateSweepRadius(Vec2 center) {
        ...
        m_sweepRadius = d.length() + m_radius - com.jbox2d.common.Settings.toiSlop;
    }

    public boolean testPoint(com.jbox2d.common.XForm transform, Vec2 p) {
        Vec2 center = transform.position.add(com.jbox2d.common.Mat22.mul(transform.R, m_localPosition));
        Vec2 d = p.sub(center);
 								...
 								float32 maxLambda) const
 {
    ...
    public void computeAABB(AABB aabb, com.jbox2d.common.XForm transform) {
        Vec2 p = transform.position.add(com.jbox2d.common.Mat22.mul(transform.R, m_localPosition));
        aabb.lowerBound.set(p.x - m_radius, p.y - m_radius);
        aabb.upperBound.set(p.x + m_radius, p.y + m_radius);
    }

    public void computeSweptAABB(AABB aabb, com.jbox2d.common.XForm transform1, com.jbox2d.common.XForm transform2) {
        Vec2 p1 = transform1.position.add(com.jbox2d.common.Mat22.mul(transform1.R, m_localPosition));
        Vec2 p2 = transform2.position.add(com.jbox2d.common.Mat22.mul(transform2.R, m_localPosition));
