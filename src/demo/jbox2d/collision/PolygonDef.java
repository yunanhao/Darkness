...
public class PolygonDef extends ShapeDef {
     ...
     */
    public List<demo.jbox2d.common.Vec2> vertices;

    public PolygonDef() {
        type = ShapeType.POLYGON_SHAPE;
        vertices = new ArrayList<demo.jbox2d.common.Vec2>();
    }

    /**
     * Add a vertex to the polygon.
     */
    public void addVertex(demo.jbox2d.common.Vec2 v) {
        vertices.add(v);
    }
     ...
     */
    public demo.jbox2d.common.Vec2[] getVertexArray() {
        return vertices.toArray(new demo.jbox2d.common.Vec2[0]);
    }

    /**
     * Return the vertex list as a List<Vec2>.
     */
    public List<demo.jbox2d.common.Vec2> getVertexList() {
        return vertices;
    }
    ...
    public void setAsBox(float hx, float hy) {
        vertices.clear();
        vertices.add(new demo.jbox2d.common.Vec2(-hx, -hy));
        vertices.add(new demo.jbox2d.common.Vec2(hx, -hy));
        vertices.add(new demo.jbox2d.common.Vec2(hx, hy));
        vertices.add(new demo.jbox2d.common.Vec2(-hx, hy));
    }
     ...
     */
    public void setAsBox(float hx, float hy, demo.jbox2d.common.Vec2 center, float angle) {
        setAsBox(hx, hy);
        XForm xf = new XForm();
