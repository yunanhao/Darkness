...
public class BroadPhase {
    ...
    public com.jbox2d.collision.PairManager m_pairManager;
    ...
    int m_freeProxy;
    com.jbox2d.collision.BufferedPair[] pairBuffer;
    ...
    public BroadPhase(AABB worldAABB, PairCallback callback) {
        ...
        pairBuffer = new com.jbox2d.collision.BufferedPair[Settings.maxPairs];
        ...
        m_pairManager = new com.jbox2d.collision.PairManager();
        ...
        m_proxyPool[Settings.maxProxies - 1].setNext(com.jbox2d.collision.PairManager.NULL_PROXY);
...
//    }
    ...
    public Proxy getProxy(int proxyId) {
        if (proxyId == com.jbox2d.collision.PairManager.NULL_PROXY
    ...
    int createProxy(AABB aabb, //int groupIndex, int categoryBits, int maskBits,
        ...
        assert (m_freeProxy != com.jbox2d.collision.PairManager.NULL_PROXY);
...
//        proxy.maskBits = maskBits;
    ...
    void moveProxy(int proxyId, AABB aabb) {
        ...
        if (proxyId == com.jbox2d.collision.PairManager.NULL_PROXY || Settings.maxProxies <= proxyId) {
            return;
        }
