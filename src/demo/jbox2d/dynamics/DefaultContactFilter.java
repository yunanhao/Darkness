...
import demo.jbox2d.collision.FilterData;
...
public class DefaultContactFilter implements ContactFilter {
     ...
     */
    public boolean shouldCollide(demo.jbox2d.collision.Shape shape1, Shape shape2) {

        demo.jbox2d.collision.FilterData filter1 = shape1.getFilterData();
