...
public class CircleContact extends Contact implements ContactCreateFcn {
    ...
    public CircleContact(demo.jbox2d.collision.Shape shape1, Shape shape2) {
        super(shape1, shape2);
        m_manifold = new demo.jbox2d.collision.Manifold();
        assert (m_shape1.getType() == demo.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
    ...
    public Contact create(demo.jbox2d.collision.Shape shape1, demo.jbox2d.collision.Shape shape2) {
    ...
    public void evaluate(ContactListener listener) {
        ...
        demo.jbox2d.collision.Manifold m0 = new demo.jbox2d.collision.Manifold(m_manifold);
        ...
        CollideCircle.collideCircles(m_manifold, (demo.jbox2d.collision.CircleShape) m_shape1, b1.m_xf, (CircleShape) m_shape2, b2.m_xf);
        ...
        if (m_manifold.pointCount > 0) {
            m_manifoldCount = 1;
            demo.jbox2d.collision.ManifoldPoint mp = m_manifold.points[0];
            if (m0.pointCount == 0) {
                ...
                if (listener != null) {
                    ...
                    cp.id = new demo.jbox2d.collision.ContactID(mp.id);
                    listener.add(cp);
                }
            } else {
                demo.jbox2d.collision.ManifoldPoint mp0 = m0.points[0];
    ...
    public List<demo.jbox2d.collision.Manifold> getManifolds() {
        List<demo.jbox2d.collision.Manifold> ret = new ArrayList<Manifold>(1);
        if (m_manifold != null) {
            ret.add(m_manifold);
        }
