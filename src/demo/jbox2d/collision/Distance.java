...
public class Distance {
    ...
    protected static int ProcessTwo(demo.jbox2d.common.Vec2 x1, demo.jbox2d.common.Vec2 x2, demo.jbox2d.common.Vec2[] p1s, demo.jbox2d.common.Vec2[] p2s, demo.jbox2d.common.Vec2[] points) {
        // If in point[1] region
        demo.jbox2d.common.Vec2 r = new demo.jbox2d.common.Vec2(-points[1].x, -points[1].y);
        demo.jbox2d.common.Vec2 d = new demo.jbox2d.common.Vec2(points[0].x - points[1].x, points[0].y - points[1].y);
        float length = d.normalize();
        float lambda = demo.jbox2d.common.Vec2.dot(r, d);
        if (lambda <= 0.0f || length < demo.jbox2d.common.Settings.EPSILON) {
    ...
    // - inside the triangle
    protected static int ProcessThree(demo.jbox2d.common.Vec2 x1, demo.jbox2d.common.Vec2 x2, demo.jbox2d.common.Vec2[] p1s, demo.jbox2d.common.Vec2[] p2s, demo.jbox2d.common.Vec2[] points) {
        demo.jbox2d.common.Vec2 a = points[0];
        demo.jbox2d.common.Vec2 b = points[1];
        demo.jbox2d.common.Vec2 c = points[2];

        demo.jbox2d.common.Vec2 ab = b.sub(a);
        demo.jbox2d.common.Vec2 ac = c.sub(a);
        demo.jbox2d.common.Vec2 bc = c.sub(b);

        float sn = -demo.jbox2d.common.Vec2.dot(a, ab), sd = demo.jbox2d.common.Vec2.dot(b, ab);
        float tn = -demo.jbox2d.common.Vec2.dot(a, ac), td = demo.jbox2d.common.Vec2.dot(c, ac);
        float un = -demo.jbox2d.common.Vec2.dot(b, bc), ud = demo.jbox2d.common.Vec2.dot(c, bc);
        ...
        float n = demo.jbox2d.common.Vec2.cross(ab, ac);

        // Should not be in edge ab region.
        float vc = n * demo.jbox2d.common.Vec2.cross(a, b);
        assert (vc > 0.0f || sn > 0.0f || sd > 0.0f);

        // In edge bc region?
        float va = n * demo.jbox2d.common.Vec2.cross(b, c);
        ...
        // In edge ac region?
        float vb = n * demo.jbox2d.common.Vec2.cross(c, a);
    ...
    protected static boolean InPoints(demo.jbox2d.common.Vec2 w, demo.jbox2d.common.Vec2[] points, int pointCount) {
        float k_tolerance = 100.0f * demo.jbox2d.common.Settings.EPSILON;
        for (int i = 0; i < pointCount; ++i) {
            demo.jbox2d.common.Vec2 d = demo.jbox2d.common.Vec2.abs(w.sub(points[i]));
//				new Vec2( Math.abs(w.x-points[i].x), Math.abs(w.y-points[i].y));//Vec2.abs(w - points[i]);
            demo.jbox2d.common.Vec2 m = demo.jbox2d.common.Vec2.max(demo.jbox2d.common.Vec2.abs(w), demo.jbox2d.common.Vec2.abs(points[i]));
     ...
     * @return
     */
    public static float DistanceGeneric(demo.jbox2d.common.Vec2 x1, demo.jbox2d.common.Vec2 x2,
                                        SupportsGenericDistance shape1, XForm xf1,
                                        SupportsGenericDistance shape2, XForm xf2) {
        demo.jbox2d.common.Vec2[] p1s = new demo.jbox2d.common.Vec2[3];
        demo.jbox2d.common.Vec2[] p2s = new demo.jbox2d.common.Vec2[3];
        demo.jbox2d.common.Vec2[] points = new demo.jbox2d.common.Vec2[3];

        for (int i = 0; i < 3; ++i) {
            p1s[i] = new demo.jbox2d.common.Vec2();
            p2s[i] = new demo.jbox2d.common.Vec2();
            points[i] = new demo.jbox2d.common.Vec2();
        }
        ...
        for (int iter = 0; iter < maxIterations; ++iter) {
            demo.jbox2d.common.Vec2 v = x2.sub(x1);
            demo.jbox2d.common.Vec2 w1 = shape1.support(xf1, v);
            demo.jbox2d.common.Vec2 w2 = shape2.support(xf2, v.negate());

            vSqr = demo.jbox2d.common.Vec2.dot(v, v);
            demo.jbox2d.common.Vec2 w = w2.sub(w1);
            float vw = demo.jbox2d.common.Vec2.dot(v, w);
            ...
            for (int i = 0; i < pointCount; ++i) {
                maxSqr = Math.max(maxSqr, demo.jbox2d.common.Vec2.dot(points[i], points[i]));
            }

            if (pointCount == 3 || vSqr <= 100.0f * demo.jbox2d.common.Settings.EPSILON * maxSqr) {
                g_GJK_Iterations = iter;
    ...
    protected static float DistanceCC(
            demo.jbox2d.common.Vec2 x1, demo.jbox2d.common.Vec2 x2,
            CircleShape circle1, XForm xf1,
            CircleShape circle2, XForm xf2) {

        demo.jbox2d.common.Vec2 p1 = XForm.mul(xf1, circle1.getLocalPosition());
        demo.jbox2d.common.Vec2 p2 = XForm.mul(xf2, circle2.getLocalPosition());

        demo.jbox2d.common.Vec2 d = new demo.jbox2d.common.Vec2(p2.x - p1.x, p2.y - p1.y);
        float dSqr = demo.jbox2d.common.Vec2.dot(d, d);
        float r1 = circle1.getRadius() - demo.jbox2d.common.Settings.toiSlop;
        float r2 = circle2.getRadius() - demo.jbox2d.common.Settings.toiSlop;
        float r = r1 + r2;
        if (dSqr > r * r) {
            ...
            x2.set(p2.x - r2 * d.x,
                    p2.y - r2 * d.y);
            return distance;
        } else if (dSqr > demo.jbox2d.common.Settings.EPSILON * demo.jbox2d.common.Settings.EPSILON) {
            d.normalize();
            x1.set(p1.x + r1 * d.x,
                    p1.y + r1 * d.y);
            x2.set(x1);
    ...
    protected static float DistancePC(
        ...
        Point point = new Point(new demo.jbox2d.common.Vec2(0.0f, 0.0f));
        point.p = XForm.mul(xf2, circle.getLocalPosition());

        float distance = DistanceGeneric(x1, x2, polygon, xf1, point, XForm.identity);

        float r = circle.getRadius() - demo.jbox2d.common.Settings.toiSlop;

        if (distance > r) {
            distance -= r;
            demo.jbox2d.common.Vec2 d = x2.sub(x1);
            d.normalize();
            x2.x -= r * d.x;
            x2.y -= r * d.y;
        } else {
     ...
     */
    public static float distance(demo.jbox2d.common.Vec2 x1, demo.jbox2d.common.Vec2 x2,
...
class Point implements SupportsGenericDistance {
    public demo.jbox2d.common.Vec2 p;

    public Point(demo.jbox2d.common.Vec2 _p) {
        p = _p.clone();
    }

    public demo.jbox2d.common.Vec2 support(XForm xf, demo.jbox2d.common.Vec2 v) {
        return p;
    }
