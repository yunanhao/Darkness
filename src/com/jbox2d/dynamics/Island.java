...
import com.jbox2d.dynamics.contacts.*;
...
public class Island {
    ...
    public com.jbox2d.dynamics.ContactListener m_listener;
    ...
    public void solve(TimeStep step, com.jbox2d.common.Vec2 gravity, boolean correctPositions, boolean allowSleep) {
        ...
        for (int i = 0; i < m_bodyCount; ++i) {
            ...
            // Taylor expansion:
            // v2 = (1.0f - c * dt) * v1
            b.m_linearVelocity.mulLocal(com.jbox2d.common.MathUtils.clamp(1.0f - step.dt * b.m_linearDamping, 0.0f, 1.0f));
            b.m_angularVelocity *= com.jbox2d.common.MathUtils.clamp(1.0f - step.dt * b.m_angularDamping, 0.0f, 1.0f);

            // Check for large velocities.
            if (com.jbox2d.common.Vec2.dot(b.m_linearVelocity, b.m_linearVelocity) > Settings.maxLinearVelocitySquared) {
        ...
        if (allowSleep) {
            ...
            for (int i = 0; i < m_bodyCount; ++i) {
                ...
                if ((b.m_flags & Body.e_allowSleepFlag) == 0 ||
                        ...
                        com.jbox2d.common.Vec2.dot(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
                    b.m_sleepTime = 0.0f;
                    minSleepTime = 0.0f;
                } else {
            ...
            if (minSleepTime >= Settings.timeToSleep) {
                for (int i = 0; i < m_bodyCount; ++i) {
                    ...
                    b.m_linearVelocity = new com.jbox2d.common.Vec2(0.0f, 0.0f);
        ...
        for (int i = 0; i < m_contactCount; ++i) {
            ...
            for (int j = 0; j < manifoldCount; ++j) {
                ...
                for (int k = 0; k < manifold.pointCount; ++k) {
                    ...
                    cr.position = com.jbox2d.common.XForm.mul(b1.getXForm(), point.localPoint1);
