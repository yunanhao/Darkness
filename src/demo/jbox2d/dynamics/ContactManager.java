...
import demo.jbox2d.dynamics.contacts.ContactPoint;
import demo.jbox2d.dynamics.contacts.NullContact;
...
public class ContactManager extends PairCallback {
    ...
    public Object pairAdded(Object proxyUserData1, Object proxyUserData2) {
        demo.jbox2d.collision.Shape shape1 = (demo.jbox2d.collision.Shape) proxyUserData1;
        demo.jbox2d.collision.Shape shape2 = (demo.jbox2d.collision.Shape) proxyUserData2;
    ...
    public void destroy(Contact c) {
        demo.jbox2d.collision.Shape shape1 = c.getShape1();
        ...
        if (manifoldCount > 0 && (m_world.m_contactListener != null)) {
            ...
            List<demo.jbox2d.collision.Manifold> manifolds = c.getManifolds();
