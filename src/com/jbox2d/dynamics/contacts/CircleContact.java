...
public class CircleContact extends Contact implements ContactCreateFcn {
    ...
    public CircleContact(com.jbox2d.collision.Shape shape1, Shape shape2) {
        super(shape1, shape2);
        m_manifold = new com.jbox2d.collision.Manifold();
        assert (m_shape1.getType() == com.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
    ...
    public Contact create(com.jbox2d.collision.Shape shape1, com.jbox2d.collision.Shape shape2) {
    ...
    public void evaluate(ContactListener listener) {
        ...
        com.jbox2d.collision.Manifold m0 = new com.jbox2d.collision.Manifold(m_manifold);
        ...
        CollideCircle.collideCircles(m_manifold, (com.jbox2d.collision.CircleShape) m_shape1, b1.m_xf, (CircleShape) m_shape2, b2.m_xf);
        ...
        if (m_manifold.pointCount > 0) {
            m_manifoldCount = 1;
            com.jbox2d.collision.ManifoldPoint mp = m_manifold.points[0];
            if (m0.pointCount == 0) {
                ...
                if (listener != null) {
                    ...
                    cp.id = new com.jbox2d.collision.ContactID(mp.id);
                    listener.add(cp);
                }
            } else {
                com.jbox2d.collision.ManifoldPoint mp0 = m0.points[0];
    ...
    public List<com.jbox2d.collision.Manifold> getManifolds() {
        List<com.jbox2d.collision.Manifold> ret = new ArrayList<Manifold>(1);
        if (m_manifold != null) {
            ret.add(m_manifold);
        }
