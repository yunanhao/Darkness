...
public class ContactSolver {
    public demo.jbox2d.dynamics.TimeStep m_step;
     ...
     */
    //*
    public demo.jbox2d.dynamics.contacts.ContactConstraint[] m_constraints;
	/*/
    ...
    public ContactSolver(demo.jbox2d.dynamics.TimeStep step, Contact[] contacts, int contactCount) {
        m_step = step;
        ...
        //*
        m_constraints = new demo.jbox2d.dynamics.contacts.ContactConstraint[m_constraintCount];
        /*/
        m_constraints = new ArrayList<ContactConstraint>(m_constraintCount);
        //*/
        for (int i = 0; i < m_constraintCount; i++) {
            //*
            m_constraints[i] = new demo.jbox2d.dynamics.contacts.ContactConstraint();
            /*/
        ...
        for (int i = 0; i < contactCount; i++) {// Contact contact : contacts) {
            ...
            demo.jbox2d.dynamics.Body b1 = contact.m_shape1.getBody();
            demo.jbox2d.dynamics.Body b2 = contact.m_shape2.getBody();
            int manifoldCount = contact.getManifoldCount();
            List<demo.jbox2d.collision.Manifold> manifolds = contact.getManifolds();
            ...
            for (int j = 0; j < manifoldCount; ++j) {// Manifold manifold :
                // manifolds) {
                demo.jbox2d.collision.Manifold manifold = manifolds.get(j);
                ...
                //*
                demo.jbox2d.dynamics.contacts.ContactConstraint c = m_constraints[count];
                /*/
                ...
                for (int k = 0; k < c.pointCount; ++k) {
                    ...
                    demo.jbox2d.dynamics.contacts.ContactConstraintPoint ccp = c.points[k];
    ...
    public void initVelocityConstraints(TimeStep step) {
        ...
        for (int i = 0; i < m_constraintCount; ++i) {
            ...
            //*
            demo.jbox2d.dynamics.contacts.ContactConstraint c = m_constraints[i];
        	/*/
        	ContactConstraint c = m_constraints.get(i);
        	//*/

            demo.jbox2d.dynamics.Body b1 = c.body1;
            demo.jbox2d.dynamics.Body b2 = c.body2;
            ...
            if (step.warmStarting) {
                ...
                for (int j = 0; j < c.pointCount; ++j) {
                    demo.jbox2d.dynamics.contacts.ContactConstraintPoint ccp = c.points[j];
