...
import com.mona.jbox2d.collision.Manifold;
import com.mona.jbox2d.collision.Shape;
import com.mona.jbox2d.collision.ShapeType;
import com.mona.jbox2d.common.MathUtils;
import com.mona.jbox2d.dynamics.Body;
import com.mona.jbox2d.dynamics.ContactListener;
import com.mona.jbox2d.dynamics.World;
...
public abstract class Contact {
    ...
    public com.mona.jbox2d.collision.Shape m_shape1;
    public com.mona.jbox2d.collision.Shape m_shape2;
    ...
    public Contact(com.mona.jbox2d.collision.Shape s1, com.mona.jbox2d.collision.Shape s2) {
        this();
    ...
    static void initializeRegisters() {
        ...
        addType(new CircleContact(), com.mona.jbox2d.collision.ShapeType.CIRCLE_SHAPE,
                com.mona.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyAndCircleContact(), com.mona.jbox2d.collision.ShapeType.POLYGON_SHAPE,
                com.mona.jbox2d.collision.ShapeType.CIRCLE_SHAPE);
        addType(new PolyContact(), com.mona.jbox2d.collision.ShapeType.POLYGON_SHAPE, com.mona.jbox2d.collision.ShapeType.POLYGON_SHAPE);
        // AddType(new PolyContact(), ShapeType.BOX_SHAPE, ShapeType.BOX_SHAPE);
    }

    static void addType(ContactCreateFcn createFcn, com.mona.jbox2d.collision.ShapeType type1,
                        com.mona.jbox2d.collision.ShapeType type2) {
     ...
     */
    public static Contact createContact(com.mona.jbox2d.collision.Shape shape1, Shape shape2) {
        if (s_initialized == false) {
            initializeRegisters();
            s_initialized = true;
        }

        com.mona.jbox2d.collision.ShapeType type1 = shape1.m_type;
        com.mona.jbox2d.collision.ShapeType type2 = shape2.m_type;
    ...
    private static ContactRegister getContactRegister(com.mona.jbox2d.collision.ShapeType type1,
                                                      ShapeType type2) {
     ...
     */
    public abstract List<com.mona.jbox2d.collision.Manifold> getManifolds();
    ...
    public com.mona.jbox2d.collision.Shape getShape1() {
        return m_shape1;
    }

    public com.mona.jbox2d.collision.Shape getShape2() {
        return m_shape2;
    }
    ...
    public void update(ContactListener listener) {
        ...
        com.mona.jbox2d.dynamics.Body body1 = m_shape1.getBody();
