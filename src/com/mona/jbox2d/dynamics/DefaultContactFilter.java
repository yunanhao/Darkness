...
import com.mona.jbox2d.collision.FilterData;
...
public class DefaultContactFilter implements ContactFilter {
     ...
     */
    public boolean shouldCollide(com.mona.jbox2d.collision.Shape shape1, Shape shape2) {

        com.mona.jbox2d.collision.FilterData filter1 = shape1.getFilterData();
