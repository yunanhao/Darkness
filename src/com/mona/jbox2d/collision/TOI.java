...
public class TOI {
     ...
     */
    public static float timeOfImpact(Shape shape1, com.mona.jbox2d.common.Sweep sweep1,
                                     Shape shape2, com.mona.jbox2d.common.Sweep sweep2) {
        ...
        float t0 = sweep1.t0;
        com.mona.jbox2d.common.Vec2 v1 = sweep1.c.sub(sweep1.c0);
        com.mona.jbox2d.common.Vec2 v2 = sweep2.c.sub(sweep2.c0);
        float omega1 = sweep1.a - sweep1.a0;
        float omega2 = sweep2.a - sweep2.a0;

        float alpha = 0.0f;

        com.mona.jbox2d.common.Vec2 p1 = new com.mona.jbox2d.common.Vec2();
        com.mona.jbox2d.common.Vec2 p2 = new com.mona.jbox2d.common.Vec2();
        final int k_maxIterations = 20;    // TODO_ERIN b2Settings
        int iter = 0;
        com.mona.jbox2d.common.Vec2 normal = new com.mona.jbox2d.common.Vec2(0.0f, 0.0f);
        float distance = 0.0f;
        ...
        while (true) {
            ...
            float approachVelocityBound = com.mona.jbox2d.common.Vec2.dot(normal, v1.sub(v2)) + Math.abs(omega1) * r1 + Math.abs(omega2) * r2;
