...
public class DonutBlobContainer implements BlobContainer {
    ...
    public DonutBlobContainer(com.jbox2d.common.Vec2 _center, float _radiusSmall, float _radiusLarge) {
        centerX = _center.x;
        centerY = _center.y;
    ...
    public AABB getAABB() {
        com.jbox2d.common.Vec2 min = new com.jbox2d.common.Vec2(centerX - 1.2f * radiusLarge, centerY - 1.2f * radiusLarge);
        com.jbox2d.common.Vec2 max = new Vec2(centerX + 1.2f * radiusLarge, centerY + 1.2f * radiusLarge);
