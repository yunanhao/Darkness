...
public abstract class Shape {
    ...
    public com.jbox2d.collision.FilterData m_filter;

    public boolean m_isSensor;
    public Object m_userData;

    public Shape(com.jbox2d.collision.ShapeDef def) {
        ...
        m_sweepRadius = 0.0f;
        m_next = null;
        m_proxyId = com.jbox2d.collision.PairManager.NULL_PROXY;
        m_filter = new com.jbox2d.collision.FilterData();
     ...
     */
    public void setFilterData(com.jbox2d.collision.FilterData filter) {
        m_filter.set(filter);
    }
     ...
     */
    public abstract boolean testPoint(XForm xf, com.jbox2d.common.Vec2 p);
     ...
     * Internal
     */
    public abstract void updateSweepRadius(com.jbox2d.common.Vec2 center);

    /**
     * Internal
     */
    public boolean synchronize(BroadPhase broadPhase, XForm transform1, XForm transform2) {
        if (m_proxyId == com.jbox2d.collision.PairManager.NULL_PROXY) {
            return false;
        }
    ...
    public void destructor() {
        assert (m_proxyId == com.jbox2d.collision.PairManager.NULL_PROXY);
    }
