...
import com.mona.jbox2d.collision.MassData;
import com.mona.jbox2d.collision.Shape;
import com.mona.jbox2d.collision.ShapeDef;
import com.mona.jbox2d.common.Mat22;
import com.mona.jbox2d.dynamics.contacts.ContactEdge;
import com.mona.jbox2d.dynamics.joints.JointEdge;
...
public class Body {
     ...
     */
    public com.mona.jbox2d.common.XForm m_xf;

    /**
     * The swept motion for CCD
     */
    public com.mona.jbox2d.common.Sweep m_sweep;

    public com.mona.jbox2d.common.Vec2 m_linearVelocity;
    public float m_angularVelocity;

    public com.mona.jbox2d.common.Vec2 m_force;
    public float m_torque;

    public com.mona.jbox2d.dynamics.World m_world;
    public Body m_prev;
    public Body m_next;
     ...
     */
    public Body(BodyDef bd, com.mona.jbox2d.dynamics.World world) {
        ...
        m_xf = new com.mona.jbox2d.common.XForm();

        m_xf.position.set(bd.position);
        m_xf.R.set(bd.angle);

        m_sweep = new com.mona.jbox2d.common.Sweep();
        m_sweep.localCenter.set(bd.massData.center);
        m_sweep.t0 = 1.0f;
        m_sweep.a0 = m_sweep.a = bd.angle;
        m_sweep.c.set(com.mona.jbox2d.common.XForm.mul(m_xf, m_sweep.localCenter));
        ...
        m_force = new com.mona.jbox2d.common.Vec2(0.0f, 0.0f);
        m_torque = 0.0f;

        m_linearVelocity = new com.mona.jbox2d.common.Vec2(0.0f, 0.0f);
    ...
    public void setMassFromShapes() {
        ...
        if (m_I > 0.0f && (m_flags & e_fixedRotationFlag) == 0) {
            ...
            m_I -= m_mass * com.mona.jbox2d.common.Vec2.dot(center, center);
            assert (m_I > 0.0f);
            m_invI = 1.0f / m_I;
        } else {
            m_I = 0.0f;
     ...
     */
    public boolean setXForm(com.mona.jbox2d.common.Vec2 position, float angle) {
        assert (m_world.m_lock == false);
     ...
     */
    public com.mona.jbox2d.common.XForm getXForm() {
        com.mona.jbox2d.common.XForm xf = new com.mona.jbox2d.common.XForm();
        xf.set(m_xf);
        return xf;
    }
     ...
     */
    public com.mona.jbox2d.common.Vec2 getPosition() {
     ...
     */
    public com.mona.jbox2d.common.Vec2 getWorldCenter() {
     ...
     */
    public com.mona.jbox2d.common.Vec2 getLocalCenter() {
     ...
     */
    public com.mona.jbox2d.common.Vec2 getLinearVelocity() {
     ...
     */
    public void setLinearVelocity(com.mona.jbox2d.common.Vec2 v) {
     ...
     */
    public void applyForce(com.mona.jbox2d.common.Vec2 force, com.mona.jbox2d.common.Vec2 point) {
        if (isSleeping()) wakeUp();
        m_force.addLocal(force);
        m_torque += com.mona.jbox2d.common.Vec2.cross(point.sub(m_sweep.c), force);
    }
     ...
     * @param point   the world position of the point of application.
     */
    public void applyImpulse(com.mona.jbox2d.common.Vec2 impulse, com.mona.jbox2d.common.Vec2 point) {
        if (isSleeping()) wakeUp();
        m_linearVelocity.x += m_invMass * impulse.x;
        m_linearVelocity.y += m_invMass * impulse.y;
        m_angularVelocity += m_invI * com.mona.jbox2d.common.Vec2.cross(point.sub(m_sweep.c), impulse);
    }
     ...
     */
    public com.mona.jbox2d.common.Vec2 getWorldPoint(com.mona.jbox2d.common.Vec2 localPoint) {
        return com.mona.jbox2d.common.XForm.mul(m_xf, localPoint);
    }
     ...
     */
    public com.mona.jbox2d.common.Vec2 getWorldVector(com.mona.jbox2d.common.Vec2 localVector) {
     ...
     */
    public com.mona.jbox2d.common.Vec2 getLocalPoint(com.mona.jbox2d.common.Vec2 worldPoint) {
        return com.mona.jbox2d.common.XForm.mulT(m_xf, worldPoint);
    }
     ...
     */
    public com.mona.jbox2d.common.Vec2 getLocalVector(com.mona.jbox2d.common.Vec2 worldVector) {
    ...
    public boolean synchronizeShapes() {
        com.mona.jbox2d.common.XForm xf1 = new com.mona.jbox2d.common.XForm();
    ...
    public void synchronizeTransform() {
        ...
        com.mona.jbox2d.common.Vec2 v1 = m_sweep.localCenter;
     ...
     */
    public com.mona.jbox2d.common.Vec2 getLinearVelocityFromWorldPoint(com.mona.jbox2d.common.Vec2 worldPoint) {
        return m_linearVelocity.add(com.mona.jbox2d.common.Vec2.cross(m_angularVelocity, worldPoint.sub(m_sweep.c)));
    }
     ...
     * @return the world velocity of a point.
     */
    public com.mona.jbox2d.common.Vec2 getLinearVelocityFromLocalPoint(com.mona.jbox2d.common.Vec2 localPoint) {
