...
import com.mona.jbox2d.collision.CircleDef;
import com.mona.jbox2d.common.Vec2;
import com.mona.jbox2d.dynamics.Body;
import com.mona.jbox2d.dynamics.BodyDef;
import com.mona.jbox2d.dynamics.World;
import com.mona.jbox2d.dynamics.joints.DistanceJointDef;
import com.mona.jbox2d.dynamics.joints.Joint;
import com.mona.jbox2d.util.blob.BlobStructure.IntIntFloatFloat;
...
public class BlobMaker {
     ...
     */
    static public void createBlob(com.mona.jbox2d.util.blob.BlobStructure s, BlobContainer c, World w) {
    ...
    static public void createBlob(BlobStructure s, BlobContainer c, World w,
        ...
        com.mona.jbox2d.dynamics.Body[] bodies = new com.mona.jbox2d.dynamics.Body[nPoints];
        ...
        for (int j = 0; j < nHeight; ++j) {
            ...
            for (int i = 0; i < nWidth; ++i) {
                ...
                for (int k = 0; k < nPerCell; ++k) {
                    com.mona.jbox2d.common.Vec2 position = new Vec2(s.points.get(k).position.x + xStart,
                    ...
                    com.mona.jbox2d.dynamics.BodyDef bd = new BodyDef();
