...
public class BroadPhase {
    ...
    public BroadPhase(AABB worldAABB, PairCallback callback) {
        ...
        pairBuffer = new com.mona.jbox2d.collision.BufferedPair[Settings.maxPairs];
        ...
        m_pairManager = new com.mona.jbox2d.collision.PairManager();
        ...
        m_proxyPool[Settings.maxProxies - 1].setNext(com.mona.jbox2d.collision.PairManager.NULL_PROXY);
...
//    }
    ...
    public Proxy getProxy(int proxyId) {
        if (proxyId == com.mona.jbox2d.collision.PairManager.NULL_PROXY
    ...
    int createProxy(AABB aabb, //int groupIndex, int categoryBits, int maskBits,
        ...
        assert (m_freeProxy != com.mona.jbox2d.collision.PairManager.NULL_PROXY);
...
//        proxy.maskBits = maskBits;
    ...
    void moveProxy(int proxyId, AABB aabb) {
        ...
        if (proxyId == com.mona.jbox2d.collision.PairManager.NULL_PROXY || Settings.maxProxies <= proxyId) {
            return;
        }
